r"""Image/feature filtering building blocks (Gaussian smoothing, Gaussian noise) used by
the models in this package as low-pass / data-augmentation style transforms.
"""
...
class AddGaussianNoise(nn.Module):
    """Adds i.i.d. Gaussian noise N(mean, std) to a CUDA tensor. Note: requires a CUDA device."""
...
if __name__ == '__main__':
    # Quick manual check: apply GaussianSmoothing to a sample image and display the result.
