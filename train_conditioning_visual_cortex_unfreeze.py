...
from dataloader import cond_dataloader, cond_dataloader2
import argparse
...
parser.add_argument('-l', '--gabor_dir', action='store', dest='gabor_dir', type=str, nargs='*',
                    default=['./data/gabor_patch_full/freq20/gabor-gaussian-45-freq20-cont100.png',
                             './data/gabor_patch_full/freq20/gabor-gaussian-135-freq20-cont100.png'],
...
parser.add_argument('--model_dir', default='./savedmodel/Conditioning_Experiment13', type=str, help='where to save the trained model')
...
parser.add_argument('--random_seed', default=1, type=int, help='This part is for controlling the random seed for reproductability')
