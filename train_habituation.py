...
parser.add_argument('-l', '--gabor_dir', action='store', dest='gabor_dir', type=str, nargs='*',
                    default=['./data/gabor_RSA/gabor-gaussian-15-freq20-cont100.png',
                             './data/gabor_RSA/gabor-gaussian-25-freq20-cont100.png',
                             './data/gabor_RSA/gabor-gaussian-35-freq20-cont100.png',
                             './data/gabor_RSA/gabor-gaussian-45-freq20-cont100.png',
                             './data/gabor_RSA/gabor-gaussian-55-freq20-cont100.png',
                             './data/gabor_RSA/gabor-gaussian-65-freq20-cont100.png',
                             './data/gabor_RSA/gabor-gaussian-75-freq20-cont100.png',
                             './data/gabor_RSA/gabor-gaussian-135-freq20-cont100.png',
],
                    help="Examples: -i item1 item2, -i item3")

parser.add_argument('--TRAIN', default='IAPS_10-10-80_train3_neutral', type=str,
...
parser.add_argument('--csv_train', default='./data/IAPS_10-10-80_train3_neutral.csv', type=str,
...
parser.add_argument('--model_dir', default='./savedmodel/Conditioning_Experiment4', type=str, help='where to save the trained model')
...
parser.add_argument('--random_seed', default=4, type=int, help='This part is for controlling the random seed for reproductability')
