...
from dataloader import cond_dataloader, cond_dataloader2, hab_dataloader
import argparse
...
parser.add_argument('-l', '--gabor_dir', action='store', dest='gabor_dir', type=str, nargs='*',
                    default=['./data/gabor_RSA3/gabor-gaussian-15-freq20-cont100.png',
                             './data/gabor_RSA3/gabor-gaussian-25-freq20-cont100.png',
                             './data/gabor_RSA3/gabor-gaussian-35-freq20-cont100.png',
                             './data/gabor_RSA3/gabor-gaussian-45-freq20-cont100.png',
                             './data/gabor_RSA3/gabor-gaussian-55-freq20-cont100.png',
                             './data/gabor_RSA3/gabor-gaussian-65-freq20-cont100.png',
                             './data/gabor_RSA3/gabor-gaussian-75-freq20-cont100.png',
                             './data/gabor_RSA3/gabor-gaussian-135-freq20-cont100.png'],
                    help="Examples: -i item1 item2, -i item3")

parser.add_argument('--TRAIN', default='IAPS_10-10-80_train3_neutral2', type=str,
...
parser.add_argument('--csv_train', default='./data/IAPS_10-10-80_train3_neutral2.csv', type=str,
...
parser.add_argument('--model_dir', default='./savedmodel/Conditioning_Experiment5', type=str, help='where to save the trained model')
...
parser.add_argument('--random_seed', default=30, type=int, help='This part is for controlling the random seed for reproductability')
        ...
        for phase in [TRAIN, VAL]:
            ...
            if phase == VAL:
                if args.model_save_mode == 1:
                    ...
                    os.path.join(args.model_dir, args.model_name[:-4] + '_epoch' + str(best_epoch)+ '.pth'))
...
def main():
    ...
    optimizer_ft = optim.SGD(model.parameters(), lr=args.lr, momentum=1.0, weight_decay=1e-5)
    ...
    dataloaders_test, dataset_sizes_test = hab_dataloader(args.data_dir, args.TRAIN, args.VAL,
                                                                args.TEST,
    ...
    dataloaders_train, dataset_sizes_train = hab_dataloader(args.data_dir, args.TRAIN, args.VAL,
                                                                  args.TEST,
                                                                  args.csv_train, args.csv_val,
                                                                  args.csv_test,
